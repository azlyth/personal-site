...
That means the only thing I had to do on my server was install [Docker](https://www.docker.com/what-docker) (which is made easy by [Docker Machine](https://docs.docker.com/machine/overview/#/what-is-docker-machine)). The rest happens inside containers that play well with each other thanks to [Docker Compose](https://docs.docker.com/compose/overview/#/overview-of-docker-compose).
...
And so our final service, the Git repository. I went with [Gogs](https://gogs.io). I originally liked Gogs because of it's portability, thanks to it being a single binary. Considering I'm running it inside a container, that doesn't matter as much, but oh well.
